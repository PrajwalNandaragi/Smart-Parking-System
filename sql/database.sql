...
--   - vehicle_number: Unique globally (no duplicates allowed across all users)
-- ============================================================================
...
('Main Parking Lot', 'Building A - Ground Floor', 50.00),
('VIP Parking', 'Building B - Basement', 75.00),
('Visitor Parking', 'Building C - Ground Floor', 40.00);
